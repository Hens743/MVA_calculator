    ...
    if uploaded_file:
        try:
            ...
            if 'Price' not in df.columns:
                ...
                selected_cell_value = st.selectbox("Select cell value to update price box", options=edited_df['Price'].tolist(), index=0)
                
                # Update the price input with the selected cell value
                st.session_state.price = selected_cell_value
